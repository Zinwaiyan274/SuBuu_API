    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p class="email-footer">
                {{ __('If you\'re having trouble clicking the "Password Reset Link" button, copy and paste the URL below into your web browser') }}:
                <span class="hyper-link">{{ $data['url'] }}</span>
            </p>
        </div>
