                        ...
                        <div class="order-form-section">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-4">
                                    <ul class="nav nav-pills flex-column shadow w-280 p-2" id="myTab4" role="tablist">
                                        <li class="nav-item">
                                        ...
                                        {{-- <li class="nav-item">
                                            <a href="#MailChimp" class="add-report-btn nav-link" data-bs-toggle="tab">{{ __('MailChimp') }}</a>
                                        </li> --}}

                                        {{-- <li class="nav-item">
                                            <a href="#pusher" class="add-report-btn nav-link" data-bs-toggle="tab">{{ __('Pusher Settings') }}</a>
                                        </li> --}}
                                        {{-- <li class="nav-item">
                                            <a href="#redis_method" class="add-report-btn nav-link" data-bs-toggle="tab">{{ __('Redis Settings (Cache Driver)') }}</a>
                                        </li> --}}
                                        {{-- <li class="nav-item">
                                            <a href="#memcached" class="add-report-btn nav-link" data-bs-toggle="tab">{{ __('Memcached Settings (Cache Driver)') }}</a>
                                        </li> --}}
                                ...
                                <div class="col-12 col-sm-12 col-md-8">
                                    <form enctype="multipart/form-data" method="post" class="ajaxform" action="{{ route('env.store') }}">
                                        @csrf
                                        <div class="tab-content no-padding" id="myTab2Content">
                                            <div class="tab-pane fade show active" id="app">
                                                ...
                                                {{-- <div class="form-group">
                                                    <label><a href="https://apilayer.com/marketplace/currency_data-api"  target="_blank">{{ __('APILAYER_API_KEY') }}</a></label>
                                                    <input type="text" name="APILAYER_API_KEY" class="form-control" value="{{ env('APILAYER_API_KEY') }}">
                                                </div> --}}
                                                {{-- <div class="form-group">
                                                ...
                                                {{-- <div class="form-group">
                                                    <label>{{ __('Google MEASUREMENT ID') }}</label>
                                                    <input type="text" name="GA_MEASUREMENT_ID" class="form-control" value="{{ env('GA_MEASUREMENT_ID') }}">
                                                </div> --}}
                                                {{-- <div class="form-group">
                                            ...
                                            {{-- <div class="tab-pane fade" id="MailChimp">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  name="MAILCHIMP_DRIVER" class="form-control" value="{{ env('MAILCHIMP_DRIVER','api') }}">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="tab-pane fade" id="Drivers">
                                                {{-- <div class="form-group">
                                                    ...
                                                    <input type="text" required="" name="BROADCAST_DRIVER" class="form-control" value="pusher">
                                                </div> --}}
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="CACHE_DRIVER">
                                                        ...
                                                        <option value="file" @if(env('CACHE_DRIVER') == 'file') selected="" @endif>{{ __('File (Good Performance)') }}</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" required="" name="SESSION_LIFETIME" class="form-control" value="{{ env('SESSION_LIFETIME') ?? 120 }}">
                                                </div>
                                            ...
                                            {{-- <div class="tab-pane fade" id="pusher">
                                                <div class="form-group">
                                                    <label>{{ __('PUSHER_APP_ID') }}</label>
                                                    <input type="text"  name="PUSHER_APP_ID" class="form-control" value="{{ env('PUSHER_APP_ID','local') }}">
                                                </div>

                                                <div class="form-group">
                                                    <label>{{ __('PUSHER_APP_KEY') }}</label>
                                                    <input type="text"  name="PUSHER_APP_KEY" class="form-control" value="{{ env('PUSHER_APP_KEY','local') }}">
                                                </div>
                                                <div class="form-group">
                                                    <label>{{ __('PUSHER_APP_SECRET') }}</label>
                                                    <input type="text"  name="PUSHER_APP_SECRET" class="form-control" value="{{ env('PUSHER_APP_SECRET','local') }}">
                                                </div>
                                                <div class="form-group">
                                                    <label>{{ __('PUSHER_APP_CLUSTER') }}</label>
                                                    <input type="text"  name="PUSHER_APP_CLUSTER" class="form-control" value="{{ env('PUSHER_APP_CLUSTER','mt1') }}">
                                                </div>
                                            </div> --}}
                                            ...
                                            {{-- <div class="tab-pane fade" id="memcached">
