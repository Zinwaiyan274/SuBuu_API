    ...
    <div class="container-fluid">
        <div class="table-header justify-content-end border-0 p-0">
            <div class="button-group nav" role="tablist">
                <a href="{{ route('blog-category') }}" class="add-report-btn active">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-8">
                        <div class="order-form-section">
                            <form action="{{route('update-movie-category',['id'=> $info->id])}}" method="post" class="add-brand-form ajaxform_instant_reload" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="button-group text-center mt-5">
                                            <a href="{{ route('movie-category') }}" class="theme-btn border-btn m-2">{{ __('Cancel') }}</a>
