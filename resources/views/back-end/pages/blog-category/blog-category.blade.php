    ...
    <div class="container-fluid">
        ...
        <div class="tab-content order-summary-tab">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input status-item" type="checkbox"  name="status_{{$category->id}}" id="status_{{$category->id}}" value="{{$category->status}}"  {{$category->status==1?'checked':''}} data-id ="{{$category->id}}" data-status="Blog Category Status" >
                                        </div>
                                    </td>
                                    <td>
                                        <div class="dropdown table-action">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="{{ route('edit-blog-category', ['id' => $category->id]) }}">
                                                        <i class="fal fa-pencil-alt"></i>
                                                        {{ __('Edit') }}
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('delete-blog-category',$category->id) }}" class="confirm-action" data-method="DELETE">
            ...
            <div class="tab-pane fade" id="ctg-add">
                <div class="table-header">
                    <h4>{{ __('Create Blog cateogry') }}</h4>
                </div>
                <div class="row">
                    <div class="col-sm-8">
                        <div class="modal-body order-form-section">
                            <form action="{{ route('new-blog-category') }}" method="post" class="ajaxform_instant_reload" enctype="multipart/form-data">
                                @csrf
